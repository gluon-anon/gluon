...
void GluonCodec::ThreadState::decode_row(Left & left_model,
                                          Middle& middle_model,
                                          Right& right_model,
                                          int curr_y,
...
void GluonCodec::ThreadState::decode_row_wrapper(BlockBasedImagePerChannel<true>& image_data,
...
void GluonCodec::ThreadState::decode_row(BlockBasedImagePerChannel<force_memory_optimization>& image_data,
                                          Sirikata::Array1d<uint32_t,
                                                            (uint32_t)ColorChannel::
                                                            NumBlockTypes> component_size_in_blocks,
                                          int component,
...
CodingReturnValue GluonCodec::ThreadState::vp8_decode_thread(unsigned int thread_id,
